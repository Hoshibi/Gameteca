...
import DAO.Conexao;
import DAO.JogoDAO;
import controller.EditarJogoController;
...
public class EditarJogoView extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EditarJogoView
     */
    public EditarJogoView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btSalvar.setFont(new java.awt.Font("Arial Black", 1, 11)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarJogoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarJogoView().setVisible(true);
            }
        });
    }
